  ...
  return (
    <footer className="bg-navy-brand text-cream-200 pt-14 pb-6">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-10 pb-10 border-b border-navy-mid">

          {/* Brand */}
          <div className="col-span-2 md:col-span-1">
            <h3 className="font-display text-xl text-white mb-1">Tyoohar Ghar</h3>
            <p className="font-body text-xs text-rose-light tracking-widest uppercase mb-4">
              Festive Gifting
            </p>
            ...
            <a
              href="https://www.instagram.com/tyoohar_ghar"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-sm text-rose-light hover:text-white transition-colors"
            >
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                ['Karwa Chauth', '/collections/karwa-chauth'],
                ['Christmas',    '/collections/christmas'],
                ['Weddings',     '/collections/wedding'],
                ['Baby Shower',  '/collections/baby-shower'],
              ].map(([label, to]) => (
                <li key={to}>
                  <Link to={to} className="font-body text-sm text-cream-300 hover:text-rose-light transition-colors">
                    {label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <p className="font-body text-sm text-cream-300 mb-4 leading-relaxed">
              All orders through WhatsApp. We respond within 30 minutes during business hours (10 AM – 9 PM).
            </p>
            <a
              href={WA}
              target="_blank"
