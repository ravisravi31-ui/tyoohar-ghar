...
const WA_FD   = 'https://wa.me/919599004265?text=Hi%21%20I%27m%20interested%20in%20a%20Father%27s%20Day%20hamper';
  ...
  return (
    <>
      <SEOHead
        ...
        description="Tyoohar Ghar curates premium festive gift hampers for Diwali, Rakhi, Father's Day and every Indian celebration. Handwritten cards included. Free PAN India delivery."
        canonical="/"
      />
      ...
      <section className="bg-gradient-to-br from-cream-100 via-cream-200 to-rose-pale">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 md:py-20 grid md:grid-cols-2 gap-10 md:gap-12 items-center">
          ...
          <div className="hidden md:flex items-center justify-center">
            <div className="w-80 h-80 bg-gradient-to-br from-rose-pale to-gold-pale rounded-3xl flex flex-col items-center justify-center shadow-xl">
      ...
      <section className="bg-navy-brand py-4 overflow-x-auto">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex gap-3 md:gap-6 md:justify-center min-w-max md:min-w-0">
            {festivals.map(f => (
      ...
      <section className="bg-cream-200 py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="bg-white rounded-3xl overflow-hidden shadow-md grid md:grid-cols-2">
            <div className="bg-gradient-to-br from-gold-pale to-rose-pale p-8 md:p-10 flex items-center justify-center min-h-44 md:min-h-52">
              <div className="text-center">
                ...
                <p className="font-body text-sm text-rose-brand">June 21 &middot; Order by June 18</p>
              </div>
            </div>
      ...
      <section className="bg-cream-100 py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {trustPoints.map(p => (
              <div key={p.title} className="card p-4 md:p-6 text-center">
                <span className="text-3xl md:text-4xl mb-3 md:mb-4 block">{p.icon}</span>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
            {hampers.map(h => (
              <div key={h.name} className="card flex flex-col">
                <div className="bg-gradient-to-br from-rose-pale to-gold-pale h-44 md:h-52 flex items-center justify-center">
                  <div className="text-center">
